...
Open an [issue](https://github.com/beatlabs790dev-creator/BeatWave/issues) with repro steps, your Android version/device, and `adb logcat` output if it's a crash. For anything real-time (playback glitches, Listen Together sync), a screen recording helps a lot.
